import { Dispatch, SetStateAction, MouseEvent, ReactElement, useState } from 'react';
...
export default function InfoTable() {
  ...
  const table = getTable(dataColumns, showData, colourMap, lumSort, setShowData, setDataColumns);
  return (
...
function getTable(
  ...
  const tableAccumulator = getTableAccumulator(dataColumns, classNames, showData, colourMap);
  const { csv, jsx } = colourArray.reduce(tableReducer, tableAccumulator);
  const flexBoxes = getFlexBoxes(jsx, setShowData, showData, dataColumns, setDataColumns, csv, colourMap);
  return flexBoxes;
}

function getFlexBoxes(
  jsx: ReactElement[][],
  setShowData: Dispatch<SetStateAction<string>>,
  showData: string,
  dataColumns: Set<string>,
